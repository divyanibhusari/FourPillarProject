  ...
  return (
    ...
    >
      ...
      <path 
        ...
        stroke={lightMode ? "#003B72" : "#3b82f6"} 
        strokeWidth="11" 
        strokeLinecap="round" 
        fill="none" 
      />
      ...
      <polygon points="108,175 108,136 123,124 123,175" fill={lightMode ? "#1f73b8" : "#60a5fa"} />
      <polygon points="123,124 130,131 130,175 123,175" fill={lightMode ? "#023466" : "#1e3a8a"} />
      ...
      {/* Pillar 2 */}
      <polygon points="133,175 133,111 148,99 148,175" fill={lightMode ? "#1f73b8" : "#60a5fa"} />
      <polygon points="148,99 155,106 155,175 148,175" fill={lightMode ? "#023466" : "#1e3a8a"} />
      ...
      {/* Pillar 3 */}
      <polygon points="158,175 158,86 173,74 173,175" fill={lightMode ? "#1f73b8" : "#60a5fa"} />
      <polygon points="173,74 180,81 180,175 173,175" fill={lightMode ? "#023466" : "#1e3a8a"} />
      ...
      <polygon points="183,175 183,61 198,49 198,175" fill={lightMode ? "#1f73b8" : "#60a5fa"} />
      <polygon points="198,49 205,56 205,175 198,175" fill={lightMode ? "#023466" : "#1e3a8a"} />
  ...
  return (
    ...
    >
      ...
      <g transform="translate(10, 5)">
        ...
        {/* Pillar 1 */}
        <polygon points="108,175 108,136 123,124 123,175" fill={elementBlue} />
        <polygon points="123,124 130,131 130,175 123,175" fill={darkBlue} />
        <line x1="113" y1="145" x2="118" y2="141" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="113" y1="155" x2="118" y2="151" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="113" y1="165" x2="118" y2="161" stroke="white" strokeWidth="1.5" strokeLinecap="round" />

        {/* Pillar 2 */}
        <polygon points="133,175 133,111 148,99 148,175" fill={elementBlue} />
        <polygon points="148,99 155,106 155,175 148,175" fill={darkBlue} />
        <line x1="138" y1="120" x2="143" y2="116" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="138" y1="130" x2="143" y2="126" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="138" y1="140" x2="143" y2="136" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="138" y1="150" x2="143" y2="146" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        ...
        {/* Pillar 3 */}
        <polygon points="158,175 158,86 173,74 173,175" fill={elementBlue} />
        <polygon points="173,74 180,81 180,175 173,175" fill={darkBlue} />
        <line x1="163" y1="95" x2="168" y2="91" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="163" y1="105" x2="168" y2="101" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="163" y1="115" x2="168" y2="111" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="163" y1="125" x2="168" y2="121" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        ...
        {/* Pillar 4 */}
        <polygon points="183,175 183,61 198,49 198,175" fill={elementBlue} />
        <polygon points="198,49 205,56 205,175 198,175" fill={darkBlue} />
        <line x1="188" y1="70" x2="193" y2="66" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="188" y1="80" x2="193" y2="76" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="188" y1="90" x2="193" y2="86" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="188" y1="100" x2="193" y2="96" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
